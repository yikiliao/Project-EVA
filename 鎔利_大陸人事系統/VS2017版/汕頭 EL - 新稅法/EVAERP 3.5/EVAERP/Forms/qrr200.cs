...
{
    public partial class qrr200 : Form
    {        
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var count = 0;
            count = prt035L.ToDoList(YY, Dept, Cdept, Prno).Count();
            if (count == 0)
            {
                Config.Show("...無符合資料...");
        ...
        private void Print_cs(string Dept, string Cdept, Int16 YY, string Prno)
        {
            ...
            CrystalReport_qrr001 rp = new CrystalReport_qrr001();
            rp.SetDataSource(prt035L.ToDoList(YY,Dept,Cdept,Prno));
            ...
            rp.SetParameterValue("ReportId", "qrr200");//程式編號            

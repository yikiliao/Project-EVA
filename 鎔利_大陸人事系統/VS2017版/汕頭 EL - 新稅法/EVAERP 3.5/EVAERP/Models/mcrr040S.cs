    ...
    class mcrr040S
    {
        ...
        public static IEnumerable<mcrr040S> ToDoList(string Cdept, Int16 Year, Int16 Month, string Type) //S廠
        {
            ...
            foreach (var item in pp)
            {
                ...
                var p_aa = mcrr014.ToDoList("S", "").Where(a => a.Pr_No == item.Pr_No).ToList();
                yield return new mcrr040S
                {
                    ...
                    Amt_10 = qq[4],//實納稅額
                    Amt_12 =0,
                    Pr_Birth = p_aa[0].Pr_Birth_Date.ToString("yyyy/MM/dd"),
                    Sex = p_aa[0].Pr_Sex,
                    Local = p_aa[0].Pr_Local_Addr,
                    School = p_aa[0].Pr_Schl,
                };
            }

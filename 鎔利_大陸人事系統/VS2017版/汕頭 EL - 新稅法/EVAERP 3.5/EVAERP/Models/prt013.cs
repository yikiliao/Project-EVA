...
namespace EVAERP.Models
{
    class prt013
    {
        ...
        public static IEnumerable<prt013> ToDoList(string Dept, string Nation, string Tax_date, string DataRang)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            sql = null;
        ...
        public static prt013 Get(string Dept, string Nation, string Tax_date, string DataRang)
        {
            // 查詢資料庫資料
            ArrayList parm = new ArrayList();
            parm.Add(Dept);
        ...
        public static prt013 GetWith(string Dept, string Nation, string Tax_date, string DataRang)
        {
            // 查詢資料庫資料
            ArrayList parm = new ArrayList();
            parm.Add(Dept);

...
{
    public partial class pri040 : Form
    {
        int i = 0;
        string Menu_Sel;
        ...
        {            
            ...
            f_pay_11.TextAlign = HorizontalAlignment.Right;
            f_pay_12.TextAlign = HorizontalAlignment.Right;
        }
        ...
        private string f_Insert_prt021()
        {
            ...
            p_prt021.Pay_11 = Convert.ToDecimal(f_pay_11.Text);
            p_prt021.Pay_12 = Convert.ToDecimal(f_pay_12.Text);
        ...
        {
            LS1.Clear();
            LS1 = prt021.ToDoList(Dept, f_pr_no.Text, null).ToList();
            if (LS1.Count() == 0)
            {
                Config.Show("無符合資料");
                return;
        ...
        private void f_show(int idx)
        {
            ...
            else
            {
                ...
                f_pay_11.Text = LS1[idx].Pay_11.ToString();
                f_pay_12.Text = LS1[idx].Pay_12.ToString();
        ...
        private void Find_p(string Pr_no)
        {
            ...
            f_cdept.Text = (p_prt016 == null ? "" : p_prt016.Pr_cdept);
        ...
        private void Find_p_Add(string Pr_no)
        {
            ...
            f_cdept.Text = p_prt016.Pr_cdept;
            f_cdept_name.Text = prt001.Get(f_cdept.Text) == null ? "" : prt001.Get(f_cdept.Text).Department_name_new;
            D_work(Dept);//下拉選單-職等
            f_code.SelectedValue = p_prt016.Wk_code;//職等設定進去
        }
        ...
        private void f_code1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            p_prt011 = prt011.Get(Dept, f_code.Text);
        ...
        {
            Int32 p3, p4, p5, p6, p7, p8, p9, p11, p12, aa = 0;
            ...
            p11 = string.IsNullOrEmpty(f_pay_11.Text) ? 0 : Convert.ToInt32(f_pay_11.Text);
            p12 = string.IsNullOrEmpty(f_pay_12.Text) ? 0 : Convert.ToInt32(f_pay_12.Text);
            aa = p3 + p4 + p5 + p6 + p7 + p8 + p9 + p11 + p12;
            ...
            if (Menu_Sel == "Add" || Menu_Sel == "Upd")
            {
                ...
                if (string.IsNullOrEmpty(f_pay_11.Text)) f_pay_11.Text = "0";
                if (string.IsNullOrEmpty(f_pay_12.Text)) f_pay_12.Text = "0";
            }
        ...
        private void f_pay_11_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
                f_pay_12.Focus();
        }

        private void f_pay_12_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
                f_pay_3.Focus();
        }
        ...
        private void pri040_KeyDown(object sender, KeyEventArgs e)
        {
            //新增(Control+A)

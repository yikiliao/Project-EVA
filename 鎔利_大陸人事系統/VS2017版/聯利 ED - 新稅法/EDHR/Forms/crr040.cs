...
namespace EDHR.Forms
{
    ...
    {   
        ...
        List<mcrr040D> Lmcrr040D = new List<mcrr040D>(); 
        public crr040()
        {
            InitializeComponent();            
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Lmcrr040D.Clear();
            Lmcrr040D = mcrr040D.ToDoList(Cdept, YY, MM, Type).ToList();
            count = Lmcrr040D.Count();
            ...
            {
                S_Print_cs(Dept, Cdept, YY, MM, Type, Lmcrr040D);
            }
        ...
        private void S_Print_cs(string Dept, string Cdept, Int16 YY, Int16 MM, string Type, List<mcrr040D> Lmcrr040D)
        {
            var rpname = "個人所得申報表";

            //CrystalReport_crr040S rp = new CrystalReport_crr040S();//原先的可以用
            CrystalReport_crr040X rp = new CrystalReport_crr040X();
            rp.SetDataSource(Lmcrr040D);

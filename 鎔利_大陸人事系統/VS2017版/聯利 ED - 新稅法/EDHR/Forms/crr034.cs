...
{
    public partial class crr034 : Form
    {   
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (mcrr034.ToDoList(Dept, Cdept,Beg_date,End_date).Count() == 0)
            {
                Config.Show("...無符合資料...");
        ...
        {            
            ...
            rp.SetDataSource(mcrr034.ToDoList(Dept, Cdept, Beg_date, End_date));
            ...
            rp.SetParameterValue("ReportId", "crr034");//程式編號            

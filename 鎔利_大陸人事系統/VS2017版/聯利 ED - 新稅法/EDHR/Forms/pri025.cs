...
namespace EDHR.Forms
{
    public partial class pri025 : Form
    {
        ...
        private string f_Insert_1()
        {
            ...
            p_prt031L.Cdept_no = f_pr_cdept.Text;
        ...
        {   
            var p_prt031L = new prt031L();
            p_prt031L.Pr_no = f_pr_no.Text;
            p_prt031L.Yy = Convert.ToDecimal(f_yy.Text);
            p_prt031L.Mm = Convert.ToDecimal(f_mm.Text);
            p_prt031L.Pr_sqe = Convert.ToDecimal(f_pr_sqe.Text);
            p_prt031L.Tot_wtime = string.IsNullOrEmpty(f_tot_wtime.Text) ? 0 : System.Convert.ToDecimal(f_tot_wtime.Text);
            p_prt031L.Tot_vtime1 = string.IsNullOrEmpty(f_tot_vtime1.Text) ? 0 : System.Convert.ToDecimal(f_tot_vtime1.Text);
            p_prt031L.Tot_vtime2 = string.IsNullOrEmpty(f_tot_vtime2.Text) ? 0 : System.Convert.ToDecimal(f_tot_vtime2.Text);
        ...
        {
            decimal? _yy =Convert.ToDecimal(f_yy.SelectedValue.ToString());
            decimal? _mm = Convert.ToDecimal(f_mm.SelectedValue.ToString());            
            LS1.Clear();
            LS1 = prt031L.ToDoList(_yy, _mm, f_pr_cdept.Text ,f_pr_no.Text, 1).ToList();           
        ...
        private void FontBlod(bool Blod)
        {
            foreach (Control c in this.Motherboard.Controls)
            {
        ...
        {            
            ...
            {                
                ...
                //有出勤資料
                if (prt030L.ToDoListByGroup(f_pr_dept.Text, Yy, Mm, f_pr_no.Text).Count() > 0)
                {                    
                    //出勤時數(平日)
        ...
        private void Sum_Pay1(object sender, EventArgs e)
        {
            decimal amt1 = 0, amt2 = 0, amt3 = 0, amt4 = 0, amt5 = 0, amt6 = 0, amt7 = 0,
                ...
                amt16 = 0, amt17 = 0, amt19 = 0, amt20 = 0, amt29 = 0, amt25 = 0, amt26 = 0, amt27 = 0, amt28 = 0, amt30 = 0, amt31 = 0;
            if (Menu_Sel == "Add" || Menu_Sel == "Upd")
            {
                ...
                amt16 = amt1 + amt2 + amt3 +
                     ...
                     amt10 + amt13 + amt27 - amt11 - amt12 - amt15;
                f_amt_16.Text = amt16.ToString();
                                
                //所得稅
                //amt19 = prt031L.Tax(Dept, (int)f_yy.SelectedValue, (int)f_mm.SelectedValue, f_pr_no.Text, amt16, amt29, amt30);                
        ...
        private void Sum_Pay2(object sender, EventArgs e)
        {
            ...
            if (Menu_Sel == "Add" || Menu_Sel == "Upd")
            {
                ...
                //所得稅
                //amt19 = prt031L.Tax(Dept, (int)f_yy.SelectedValue, (int)f_mm.SelectedValue, f_pr_no.Text, amt16, amt29, amt30, amt31);
                amt19 = prt031L.Tax(Dept, (int)f_yy.SelectedValue, (int)f_mm.SelectedValue, f_pr_no.Text, amt16, amt28, amt29, amt30, amt31);
                if (amt19 < 0) amt19 = 0;
                f_amt_19.Text = amt19.ToString();

                //實發金額
                //amt25 = amt16 - amt17 - amt19 - amt20 - amt29 - amt30 - amt31;
        ...
        private void f_tot_wtime_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
                f_tot_vtime1.Focus();
        }

        private void f_tot_vtime1_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
            f_tot_vtime2.Focus();
        }

        private void f_tot_vtime2_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
                f_tot_ntime.Focus();
        }

        private void f_tot_ntime_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
                f_tot_atime1.Focus();
        }

        private void f_tot_atime1_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
                f_tot_atime2.Focus();
        }

        private void f_tot_atime2_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
                f_tot_wtime.Focus();
        }

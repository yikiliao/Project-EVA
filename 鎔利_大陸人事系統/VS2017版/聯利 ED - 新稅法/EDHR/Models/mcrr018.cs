...
namespace EDHR.Models
{
    class mcrr018
    {
        ...
        public double Age_Day { get; set; } //年紀總天數

        public int Up60 { get; set; }
        public int Up50 { get; set; }
        public int Up40 { get; set; }
        public int Up30 { get; set; }
        public int Up20 { get; set; }
        public int LessUp20 { get; set; }

        #endregion

        public static IEnumerable<mcrr018> ToDoList(string Dept, string Cdept)
        {
            string sql = null;
            ...
            sql = null;
            sql += "select *,prt001.department_name_new cdept_name,prt003.code_desc a,prt002.code_desc b,sst011.company_shname comp_short_name, prt006.code_desc c, AA.code_desc d  from prt016 ";
            ...
            return from p in DeptDS.Tables[0].AsEnumerable()
                   select new mcrr018
                   {
                       ...
                       Work_Sp = prt016.CalculateAge(p.Field<string>("pr_in_date")),
                       Work_Day = prt016.CalculateDay(p.Field<string>("pr_in_date")),
                       Age_Day = prt016.CalculateDay(p.Field<string>("pr_birth_date")),

                       Up60 = Gret60(prt016.CalculateDay(p.Field<string>("pr_birth_date"))),
                       Up50 = Get(prt016.CalculateDay(p.Field<string>("pr_birth_date")), 50, 60),
                       Up40 = Get(prt016.CalculateDay(p.Field<string>("pr_birth_date")), 40, 50),
                       Up30 = Get(prt016.CalculateDay(p.Field<string>("pr_birth_date")), 30, 40),
                       Up20 = Get(prt016.CalculateDay(p.Field<string>("pr_birth_date")), 20, 30),
                       LessUp20 = LessOne(prt016.CalculateDay(p.Field<string>("pr_birth_date"))),
                   };
        }

        private static int Gret60(double DD)
        {
            int a = 0;           

...
namespace EDHR.Models
{
    class prt030L
    {
        ...
        public static IEnumerable<prt030L> ToDoListEndDate(string Pr_dept, string Pr_date1, string Pr_date2, string Pr_no)
        {
            string sql = null;
        ...
        public static IEnumerable<prt030L> ToDoListGroup(string Pr_dept, string Pr_cdept, string Pr_date)
        {
            string sql = null;
            ArrayList parm = new ArrayList();

            sql = null;
            sql += "select pr_company, pr_dept,pr_cdept,pr_date,add_date,add_user,mod_date,mod_user from prt030L where 1= 1 ";
            if (!string.IsNullOrEmpty(Pr_dept.Trim()))
            {
                parm.Add(Pr_dept.Trim());
                sql += " and pr_dept= ?";

...
namespace EVAERP.Models
{
    class prt027
    {
        ...
        public static IEnumerable<prt027> ToDoList(string Dept, string Pr_no, string Tr_id_no, string Begdate, string Enddate, string Tr_type)
        {
            string sql = null;
            ...
            //離職日起
            if (Begdate.Length > 1 && Begdate != null)            
            {
                parm.Add(Begdate);
                sql += " and tr_start_date >= ?";
            }
            //離職日迄
            if (Enddate.Length > 1 && Enddate != null)
            {
                parm.Add(Enddate);
                sql += " and tr_start_date <= ? ";
            }
            ...
            //型態
            if (!string.IsNullOrEmpty(Tr_type.Trim()))
            {
        ...
        public static prt027 Get(string Tr_id_no, decimal Tr_sqe_no)
        {
            ...
            return new prt027
            {
                ...
                CreateDate = DeptDS.Tables[0].Rows[0].Field<DateTime>("CreateDate"),
            };
        }

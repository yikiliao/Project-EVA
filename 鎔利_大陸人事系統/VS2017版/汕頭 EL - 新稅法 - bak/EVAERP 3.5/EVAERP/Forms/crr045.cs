...
namespace EVAERP.Forms
{
    ...
    {   
        ...
        List<mcrr045> Lmcrr045 = new List<mcrr045>(); 
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (OutType == "1") L_Print_cs(Dept, Cdept, YY, MM, Type, Lmcrr045);    //印A4
                if (OutType == "2") L_Print_xls(Dept, Cdept, YY, MM, Type, Lmcrr045);   //匯出xls
            }
        ...
        private void L_Print_cs(string Dept, string Cdept, Int16 YY, Int16 MM, string Type, List<mcrr045> Lmcrr045)
        {
            var rpname = "個人所得申報表";
        ...
        private void L_Print_xls(string Dept, string Cdept, Int16 YY, Int16 MM, string Type, List<mcrr045> Lmcrr045)
        {
            var rpname = "個人所得申報表";

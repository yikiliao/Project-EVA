...
namespace EVAERP.Models
{
    class mcrr024
    {
        ...
        public static IEnumerable<mcrr024> ToDoList(string Cdept, Int16 Year, Int16 Month, string Type)
        {
            ...
            sql = null;
            sql += "select prt031S.*,prt021.wk_code,prt021.code1,prt016.pr_name,prt016.pr_cdept cdept, prt001.department_name_new cdept_name,prt016.account_no,prt016.pr_idno,prt016.nation FROM prt031S ";

...
namespace EVAERP.Models
{
    class prt016
    {
        ...
        public string Old_safe_date { get; set; }
        public string Medic_safe_date { get; set; }
        public string Job_safe_date { get; set; }
        public string House_safe_date { get; set; }
        ...
        public static IEnumerable<prt016> ToDoList()
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            sql = null;
            ...
            return from p in DeptDS.Tables[0].AsEnumerable()
                   select new prt016
                   {
                       ...
                       Old_safe_date = p.IsNull("old_safe_date") ? "" : p.Field<string>("old_safe_date").Trim(),
                       Medic_safe_date = p.IsNull("medic_safe_date") ? "" : p.Field<string>("medic_safe_date").Trim(),
                       Job_safe_date = p.IsNull("job_safe_date") ? "" : p.Field<string>("job_safe_date").Trim(),
                       House_safe_date = p.IsNull("house_safe_date") ? "" : p.Field<string>("house_safe_date").Trim(),
                   };
        }
        ...
        public static IEnumerable<prt016> ToDoList(string Pr_dept, string Pr_cdept, string Pr_no, string Pr_name, string Pr_idno, string Pr_birthday, string Pr_sex, string Type)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            sql = null;
        ...
        public string Insert()
        {
            try
            {
                ...
                parm.Add(Pr_in_date.Trim().Length == 0 ? null : Pr_in_date.Trim());
                parm.Add(Pr_insr_date.Trim().Length == 0 ? null : Pr_insr_date.Trim());
                ...
                parm.Add(DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"));
                parm.Add(Pr_birth_date.Trim().Length == 0 ? null : Pr_birth_date.Trim());
                ...
                parm.Add(Old_safe_date.Trim().Length == 0 ? null : Old_safe_date.Trim());
                parm.Add(Medic_safe_date.Trim().Length == 0 ? null : Medic_safe_date.Trim());
                parm.Add(Job_safe_date.Trim().Length == 0 ? null : Job_safe_date.Trim());
                parm.Add(House_safe_date.Trim().Length == 0 ? null : House_safe_date.Trim());

                if (prt016.ToDoList().Where(a => a.Pr_no == Pr_no).ToList().Count > 0) return "已有此筆資料-相同工號";
                ...
                sql += "old_safe_date,medic_safe_date,job_safe_date,house_safe_date)";
                sql += " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        //        if (prt016.GetWithIdno(Pr_idno) != null)
        //        {
        //            return "已有此筆資料-相同ID證號\n請用復職作業";
        //        }
        //        else
        //        {
        //            string sql = null;
        ...
        public string Update(string Pr_no)
        {
            try
            {
                ...
                parm.Add(string.IsNullOrEmpty(Pr_schl) ? null : Pr_schl.Trim());
                parm.Add(string.IsNullOrEmpty(Pr_long) ? null : Pr_long.Trim());
                parm.Add(Pr_spec_yearpay);
                //parm.Add(string.IsNullOrEmpty(System.Convert.ToString(Pr_spec_yearpay)) ? 0 : Pr_spec_yearpay);
                parm.Add(Pr_spec_monthpay);
                //parm.Add(string.IsNullOrEmpty(System.Convert.ToString(Pr_spec_monthpay)) ? 0 : Pr_spec_monthpay);
                parm.Add(string.IsNullOrEmpty(Pr_tel_no) ? null : Pr_tel_no.Trim());                
                parm.Add(Pr_in_date.Trim().Length == 0 ? null : Pr_in_date.Trim());                
                parm.Add(Pr_insr_date.Trim().Length == 0 ? null : Pr_insr_date.Trim());
        ...
        public static prt016 Get(string Pr_no)
        {
            ...
            return new prt016
            {
                ...
                Old_safe_date = DeptDS.Tables[0].Rows[0].IsNull("old_safe_date") ? "" : DeptDS.Tables[0].Rows[0].Field<string>("old_safe_date").Trim(),
                Medic_safe_date = DeptDS.Tables[0].Rows[0].IsNull("medic_safe_date") ? "" : DeptDS.Tables[0].Rows[0].Field<string>("medic_safe_date").Trim(),
                Job_safe_date = DeptDS.Tables[0].Rows[0].IsNull("job_safe_date") ? "" : DeptDS.Tables[0].Rows[0].Field<string>("job_safe_date").Trim(),
                House_safe_date = DeptDS.Tables[0].Rows[0].IsNull("house_safe_date") ? "" : DeptDS.Tables[0].Rows[0].Field<string>("house_safe_date").Trim(),
        ...
        public static IEnumerable<prt016> ToDoListPrno(string Type, string Dept, string Find)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
        ...
        public static IEnumerable<prt016> ToDoListPrnoWithLeaveDataRang(string DataRang, string Pr_cdept, Int32 Mm, string Pr_leave_date)
        {
            string sql = null;
            ArrayList parm = new ArrayList();            
            parm.Add(Mm);
            parm.Add(Pr_leave_date);            
            sql = null;
            sql += "select pr_no, pr_name,pr_cdept from prt016 where 1=1 ";
            sql += " and (pr_leave_date is NULL or (month(pr_leave_date)=? and pr_leave_date >= ?))";
            if (Pr_cdept !=null)
            {
                parm.Add(Pr_cdept);
                sql += " and pr_cdept = ?";
        ...
        public static IEnumerable<prt016> ToDoListPrno2(string Dept, string Pr_cdept, string Pr_leave_date)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            sql = null;
            ...
            if (!string.IsNullOrEmpty(Pr_leave_date))
            {
                parm.Add(Pr_leave_date);
                parm.Add(Pr_leave_date);
                sql += " and pr_in_date <= ?";
                sql += " and (pr_leave_date is null or pr_leave_date > ?)";
            }            
            sql += " order by pr_no ";
        ...
        public static IEnumerable<prt016> ToDoListPrno2(string Dept, string Pr_cdept, string Pr_leave_date, string DataRang)
        {
            string sql = null;
            ArrayList parm = new ArrayList();            
            sql = null;
        ...
        //Dsc_Login 帳號
        public static string GetDscLogin()
        {
            var N1 = "EL";
        ...
        public static prt016 CalculateWorkAge(string StartDay, string EndDay)
        {
            DateTime Start_day = System.Convert.ToDateTime(StartDay);
            DateTime End_day = System.Convert.ToDateTime(EndDay);
            int years = End_day.Year - Start_day.Year;
            int months = 0;
            int days = 0;
            if (End_day < Start_day.AddYears(years) && years != 0)

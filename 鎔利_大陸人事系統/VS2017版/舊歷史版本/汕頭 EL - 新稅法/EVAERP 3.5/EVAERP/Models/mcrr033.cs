...
namespace EVAERP.Models
{
    class mcrr033
    {
        ...
        //    if (Dept == "L")
        //    {
        //        sql += "select prt030L.*,DAY(prt030L.pr_date) dd,prt001.department_name_new cdept_name,prt016.pr_name,prvacal.va_vaca,prt006.code_desc from prt030L ";
        //        sql += " LEFT OUTER JOIN prt016 on prt016.pr_no = prt030L.pr_no ";
        //        sql += " LEFT OUTER JOIN prt001 on prt001.dept = prt030L.pr_dept and prt001.department_code = prt030L.pr_cdept";
        //        sql += " LEFT OUTER JOIN prvacal on prvacal.va_pr_no = prt030L.pr_no and prvacal.va_start_date = prt030L.pr_date";
        //        sql += " LEFT OUTER JOIN prt006 on prt006.dept = prt030L.pr_dept and prt006.type_f='VC' and  prt006.code = prvacal.va_vaca";
        //        sql += " where 1=1";
        //        sql += " and prt030L.pr_dept = ?";
        //        sql += " and prt030L.pr_date >= ?";
        //        sql += " and prt030L.pr_date <= ?";
        //        //部門
        //        if (!string.IsNullOrEmpty(Cdept.Trim()))
        //        {   
        //            sql += " and prt030L.pr_cdept in" + String.Format("({0})", Cdept.Trim());
        //        }                
        //        sql += " order by prt030L.pr_no,prt030L.pr_date";
        //    }

        //    if (Dept == "S")
        //    {
        //        sql += "select prt030S.*,DAY(prt030S.pr_date) dd,prt001.department_name_new cdept_name,prt016.pr_name,prvacal.va_vaca,prt006.code_desc from prt030S ";
        //        sql += " LEFT OUTER JOIN prt016 on prt016.pr_no = prt030S.pr_no ";
        //        sql += " LEFT OUTER JOIN prt001 on prt001.dept = prt030S.pr_dept and prt001.department_code = prt030S.pr_cdept";
        //        sql += " LEFT OUTER JOIN prvacal on prvacal.va_pr_no = prt030S.pr_no and prvacal.va_start_date = prt030S.pr_date";
        //        sql += " LEFT OUTER JOIN prt006 on prt006.dept = prt030S.pr_dept and prt006.type_f='VC' and  prt006.code = prvacal.va_vaca";
        //        sql += " where 1=1";
        //        sql += " and prt030S.pr_dept = ?";
        //        sql += " and prt030S.pr_date >= ?";
        //        sql += " and prt030S.pr_date <= ?";
        //        //部門
        //        if (!string.IsNullOrEmpty(Cdept.Trim()))
        //        {
        //            sql += " and prt030S.pr_cdept in " + String.Format("({0})", Cdept.Trim());
        //        }
        //        sql += " order by prt030S.pr_no,prt030S.pr_date";
        //    }
        ...
        //    if (Dept == "L")
        //    {                
        //        sql += "select prt030L.*,DAY(prt030L.pr_date) dd,prt001.department_name_new cdept_name,prt016.pr_name from prt030L ";
        //        sql += " LEFT OUTER JOIN prt016 on prt016.pr_no = prt030L.pr_no ";
        //        sql += " LEFT OUTER JOIN prt001 on prt001.dept = prt030L.pr_dept and prt001.department_code = prt030L.pr_cdept";                
        //        sql += " where 1=1";
        //        sql += " and prt030L.pr_dept = ?";
        ...
        //        {
        //            sql += " and prt030L.pr_no in" + String.Format("({0})", Prno.Trim());
        //        }
        //        sql += " order by prt030L.pr_no,prt030L.pr_date";
        //    }
        ...
        //    if (Dept == "S")
        //    {
        //        sql += "select prt030S.*,DAY(prt030S.pr_date) dd,prt001.department_name_new cdept_name,prt016.pr_name from prt030S ";
        //        sql += " LEFT OUTER JOIN prt016 on prt016.pr_no = prt030S.pr_no ";
        //        sql += " LEFT OUTER JOIN prt001 on prt001.dept = prt030S.pr_dept and prt001.department_code = prt030S.pr_cdept";                
        //        sql += " where 1=1";
        //        sql += " and prt030S.pr_dept = ?";
        ...
        //        if (!string.IsNullOrEmpty(Prno.Trim()))
        //        {
        //            sql += " and prt030S.pr_no in " + String.Format("({0})", Prno.Trim());
        //        }
        //        sql += " order by prt030S.pr_no,prt030S.pr_date";
        //    }
        ...
        public static IEnumerable<mcrr033> ToDoList(string Dept, string Cdept, DateTime Bdate, DateTime Edate) //L廠
        {
            ...
            if (Dept == "L")
            {
                sql += "select prt030L.*,DAY(prt030L.pr_date) dd,prt016.pr_name,prvacal.va_vaca,prt006.code_desc from prt030L ";
                sql += " LEFT OUTER JOIN prt016 on prt016.pr_no = prt030L.pr_no ";
                sql += " LEFT OUTER JOIN prvacal on prvacal.va_pr_no = prt030L.pr_no and prvacal.va_start_date = prt030L.pr_date";
                sql += " LEFT OUTER JOIN prt006 on prt006.dept = prt030L.pr_dept and prt006.type_f='VC' and  prt006.code = prvacal.va_vaca";
                sql += " where 1=1";
            ...
            if (Dept == "S")
            {
                sql += "select prt030S.*,DAY(prt030S.pr_date) dd,prt016.pr_name,prvacal.va_vaca,prt006.code_desc from prt030S ";
                sql += " LEFT OUTER JOIN prt016 on prt016.pr_no = prt030S.pr_no ";
                sql += " LEFT OUTER JOIN prvacal on prvacal.va_pr_no = prt030S.pr_no and prvacal.va_start_date = prt030S.pr_date";
                sql += " LEFT OUTER JOIN prt006 on prt006.dept = prt030S.pr_dept and prt006.type_f='VC' and  prt006.code = prvacal.va_vaca";
                sql += " where 1=1";
            ...
            return from p in DeptDS.Tables[0].AsEnumerable()
                   select new mcrr033
                   {
                       Pr_Date = p.IsNull("pr_date") ? System.Convert.ToDateTime("1800-01-01") : System.Convert.ToDateTime(p.Field<string>("pr_date").Trim()),
                       Pr_Cdept = p.IsNull("pr_cdept") ? "" : p.Field<string>("pr_cdept").Trim(),
                       Pr_Cdept_Name = prt001.Get(p.Field<string>("pr_cdept").Trim()) == null ? "" : prt001.Get(p.Field<string>("pr_cdept").Trim()).Department_name_new,
                       Pr_No = p.IsNull("pr_no") ? "" : p.Field<string>("pr_no").Trim(),
                       Pr_Name = p.IsNull("pr_name") ? "" : p.Field<string>("pr_name").Trim(),
                       Dd = p.IsNull("dd") ? 0 : p.Field<int>("dd"),
                       Dm = GetChtWeek(System.Convert.ToDateTime(p.Field<string>("pr_date"))),
        ...
        public static IEnumerable<mcrr033> ToDoList(string Dept, string Cdept, DateTime Bdate, DateTime Edate, string Prno) //L廠
        {
            ...
            if (Dept == "L")
            {
                sql += "select prt030L.*,DAY(prt030L.pr_date) dd,prt016.pr_name from prt030L ";
                sql += " LEFT OUTER JOIN prt016 on prt016.pr_no = prt030L.pr_no ";
                sql += " where 1=1";
                sql += " and prt030L.pr_dept = ?";
                sql += " and prt030L.pr_date >= ?";
            ...
            if (Dept == "S")
            {
                sql += "select prt030S.*,DAY(prt030S.pr_date) dd,prt016.pr_name from prt030S ";
                sql += " LEFT OUTER JOIN prt016 on prt016.pr_no = prt030S.pr_no ";
                sql += " where 1=1";
                sql += " and prt030S.pr_dept = ?";
                sql += " and prt030S.pr_date >= ?";

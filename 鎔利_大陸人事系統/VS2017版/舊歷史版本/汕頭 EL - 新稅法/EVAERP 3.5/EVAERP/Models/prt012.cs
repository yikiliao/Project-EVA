...
namespace EVAERP.Models
{
    class prt012
    {
        ...
        public static IEnumerable<prt012> ToDoList(string Dept, string Tax_date, decimal Seq_no)
        {
            string sql = null;
            ...
            if (!string.IsNullOrEmpty(Seq_no.ToString()))
            {
                parm.Add(Seq_no);
                sql += " and seq_no =?";
            }
        ...
        public static IEnumerable<prt012> ToDoList(string Dept, string Tax_date, decimal Seq_no, string DataRang)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            sql = null;
        ...
        public static IEnumerable<prt012> ToDoList(string Dept, string Tax_date, string DataRang)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            sql = null;
        ...
        public string Update(string Dept, string Tax_date, decimal Seq_no)
        {
            try
            {
                ArrayList parm = new ArrayList();
                ...
                string sql = null;
                sql += "update prt012 set amt1=?,amt2=?,tax_rate=?,amt_sub=?,mod_date=?,mod_user=? ";
                sql += " where dept =?";
                sql += " and tax_date =?";
                sql += " and seq_no=?";
                if (DBConnector.executeSQL(Conn.GetStr(Login.DB), sql, parm) == 0)
        ...
        public static prt012 Get(string Dept, string Tax_date, decimal Seq_no, string DataRang)
        {
            // 查詢資料庫資料
            ArrayList parm = new ArrayList();
            parm.Add(Dept);
        ...
        public static prt012 Get(string Dept, decimal rAmt1)
        {
            // 查詢資料庫資料
            ArrayList parm = new ArrayList();
            parm.Add(Dept);            
            ...
            sql += "select * from prt012 ";
            sql += " where dept = ? ";            
            sql += string.Format("and {0} BETWEEN amt1 and amt2 ", rAmt1);

...
namespace EVAERP.Forms
{
    public partial class ssi903 : Form
    {
        ...
        private void f_Query()
        {
            ...
            LS1 = sst903.ToDoList(f_id.Text,f_pr_dept.SelectedValue.ToString()).ToList();
        ...
        private void f_show(int idx)
        {
            ...
            else
            {
                ...
                f_id_name.Text = umenuL.Get(LS2[idx].Id).IdName;
                f_subject.Text = LS2[idx].Subject.ToString();
                f_pr_dept.SelectedValue = LS2[idx].Pr_dept.ToString();
                ...
                bindingSource1.DataSource = sst903.GridView(f_id.Text,f_pr_dept.SelectedValue.ToString()).ToList();
            }
        }
        //新增執行
        private void f_Insert()
        {
            ...
            foreach (DataGridViewRow row in detelGridView.Rows)
            {
                ...
                p_sst903.Pr_dept = f_pr_dept.SelectedValue.ToString();
        ...
        private void f_Update()
        {
            ...
            foreach (DataGridViewRow row in detelGridView.Rows)
            {
                ...
                p_sst903.Delete(f_id.Text, detelGridView.Rows[row.Index].Cells[0].Value.ToString(),f_pr_dept.SelectedValue.ToString());

...
{
    public partial class qrr215 : Form
    {   
        ...
        private void set_outtype()
        {
            ...
            data.Add(new DictionaryEntry("1.預付獎金列印", "1"));
            data.Add(new DictionaryEntry("2.年終獎金列印", "2"));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {                
                ...
                {                    
                    case "1":
                        Print_cs_UAY(Dept, Cdept, YY, Prno);  //預付獎金格式
                        break;
                    case "2":
                        Print_cs_LAY(Dept, Cdept, YY, Prno);  //年終獎金格式
                        break;
                    default :
                        break;
                }
        ...
        private void Print_cs_UAY(string Dept, string Cdept, Int16 YY, string Prno)
        {
            ...
            CrystalReport_qrr004_1 rp = new CrystalReport_qrr004_1();
            ...
            rp.SetParameterValue("ReportId", "qrr215");//程式編號 
        ...
        {
            var rpname = "年終獎金明細表";
            CrystalReport_qrr004_2 rp = new CrystalReport_qrr004_2();
            ...
            rp.SetParameterValue("ReportCond", f_Cond(Dept, Cdept, YY, Prno));//列印條件
            rp.SetParameterValue("ReportId", "qrr215");//程式編號
            rp.SetParameterValue("CYear", (YY + 1).ToString());//程式編號 
            crystalReportViewer1.ReportSource = rp;
            crystalReportViewer1.Refresh();
        }

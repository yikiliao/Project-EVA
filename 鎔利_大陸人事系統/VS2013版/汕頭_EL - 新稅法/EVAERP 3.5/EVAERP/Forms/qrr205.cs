...
namespace EVAERP.Forms
{
    ...
    {        
        ...
        private void set_outtype()
        {
            ...
            data.Add(new DictionaryEntry("列印 A4 格式", "1"));
            data.Add(new DictionaryEntry("列印 XLS 格式", "2"));            
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {                
                ...
                {
                    case "1":
                        Print_cs_A4(Dept, Cdept, YY, Prno);   //A4格式
                        break;
                    case "2":
                        Print_cs_XLS(Dept, Cdept, YY, Prno);  //XLS格式
                        break;                    
                    default :
                        break;
                }

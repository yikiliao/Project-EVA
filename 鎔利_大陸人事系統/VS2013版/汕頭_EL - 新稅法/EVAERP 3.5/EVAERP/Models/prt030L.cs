...
namespace EVAERP.Models
{
    class prt030L
    {
        ...
        public static IEnumerable<prt030L> ToDoListEndDate(string Pr_dept, string Pr_cdept, string Pr_no, string Pr_date1, string Pr_date2)
        {
            string sql = null;
            ArrayList parm = new ArrayList();

            sql = null;
            sql += "select * from prt030L where 1= 1 ";
        ...
        public static IEnumerable<prt030L> ToDoList(string Pr_dept, string Pr_date,string Pr_no)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
        ...
        public static IEnumerable<prt030L> ToDoList(string Pr_dept,Int32 YY,Int32 MM, string Pr_no)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Pr_dept.Trim());
        ...
        public static IEnumerable<prt030L> ToDoListGroup(string Pr_dept, string Pr_cdept, string Pr_date1, string Pr_date2)
        {
            string sql = null;
            ArrayList parm = new ArrayList();

            sql = null;
            sql += "select pr_dept,pr_cdept,pr_date from prt030L where 1= 1 ";
            if (!string.IsNullOrEmpty(Pr_dept.Trim()))
            {
                parm.Add(Pr_dept.Trim());
                sql += " and pr_dept= ?";
            ...
            sql += " GROUP BY pr_dept,pr_cdept,pr_date ";
            sql += " order by pr_dept,pr_cdept,pr_date ";
        ...
        public static IEnumerable<prt030L> ToDoListByGroup(string Pr_dept, Int32 YY, Int32 MM)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Pr_dept.Trim());
            ...
            parm.Add(MM);
            sql = null;
            sql += "select DISTINCT pr_no from prt030L where 1= 1 ";
            sql += " and pr_dept= ?";
            sql += " and year(pr_date)= ?";
            sql += " and month(pr_date)= ?";
            sql += " order by pr_no ";
        ...
        public static IEnumerable<prt030L> ToDoListByGroup(string Pr_dept, Int32 YY, Int32 MM,string Pr_no)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Pr_dept.Trim());
        ...
        public static IEnumerable<prt030L> ToDoListByGroup(string Pr_dept, Int32 YY, Int32 MM, string Pr_no, string Cdept)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Pr_dept.Trim());
        ...
        public static IEnumerable<prt030L> ToDoListByGroup2(string Pr_dept, Int32 YY, Int32 MM, string Pr_no, string Cdept)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Pr_dept.Trim());
            ...
            parm.Add(MM);
            sql = null;
            sql += "select DISTINCT prt030L.pr_no,prt016.pr_name from prt030L,prt016 where 1= 1 ";
            sql += " and prt030L.pr_dept= ?";
            sql += " and year(prt030L.pr_date)= ?";
            sql += " and month(prt030L.pr_date)= ?";
            sql += " and prt030L.pr_no = prt016.pr_no";
            if (!string.IsNullOrEmpty(Pr_no.Trim()))
            {
                parm.Add(Pr_no.Trim());
                sql += " and prt030L.pr_no= ?";
            }
            if (!string.IsNullOrEmpty(Cdept.Trim()))
            {
                parm.Add(Cdept.Trim());
                sql += " and prt030L.pr_cdept= ?";
            }
            sql += " order by prt030L.pr_no ";
        ...
        //public static IEnumerable<prt030L> GroupCdept(string Pr_dept, Int32 YY, Int32 MM)
        //{
        //    string sql = null;
        //    ArrayList parm = new ArrayList();
        //    parm.Add(Pr_dept.Trim());
        ...
        //    parm.Add(MM);
        //    sql = null;
        //    sql += "select DISTINCT prt030L.pr_cdept,prt001.department_name_new from prt030L,prt001 where 1= 1 ";
        //    sql += " and prt030L.pr_dept= ?";
        //    sql += " and year(prt030L.pr_date)= ?";
        //    sql += " and month(prt030L.pr_date)= ?";
        //    sql += " and prt030L.pr_cdept = prt001.department_code";
        //    sql += " order by prt030L.pr_cdept";
        ...
        public static IEnumerable<prt030L> GroupCdept(string Pr_dept, Int32 YY, Int32 MM)
        {
            ...
            parm.Add(MM);
            sql = null;
            sql += "select DISTINCT prt030L.pr_cdept from prt030L where 1= 1 ";
            sql += " and prt030L.pr_dept= ?";
            sql += " and year(prt030L.pr_date)= ?";
            sql += " and month(prt030L.pr_date)= ?";           
            sql += " order by prt030L.pr_cdept";
            ...
            return from p in DeptDS.Tables[0].AsEnumerable()
                   ...
                   {
                       Department_code = p.IsNull("pr_cdept") ? "" : p.Field<string>("pr_cdept").Trim(),
                       Department_name_new = prt001.Get(p.Field<string>("pr_cdept").Trim())== null ? "" : prt001.Get(p.Field<string>("pr_cdept").Trim()).Department_name_new.Trim(),
                   };
        }
        ...
        public string Delete(string Pr_date, string Pr_no)
        {
            try
            {
                ...
                parm.Add(Pr_no.Trim());
                string sql = null;
                sql += "delete from prt030L where pr_date=? and pr_no=?";
                if (DBConnector.executeSQL(Conn.GetStr(Login.DB), sql, parm) == 0)
                    return "刪除失敗";
            }
            catch (Exception ex)
        ...
        public string Delete(string Pr_dept,string Pr_cdept, string Pr_date)
        {
            try
            {
                ...
                parm.Add(Pr_date.Trim());
                string sql = null;
                sql += "delete from prt030L where pr_dept=? and pr_cdept=? and pr_date=?";
                if (DBConnector.executeSQL(Conn.GetStr(Login.DB), sql, parm) == 0)
                    return "刪除失敗";
            }
            catch (Exception ex)
        ...
        public string Update(string Pr_date, string Pr_no)
        {
            try
            {
                ...
                parm.Add(Pr_no.Trim());
                string sql = null;
                sql += "update prt030L set pr_wtime=?,pr_atime=?,pr_add1=?,pr_add2=?,va_time1=?,va_time2=?,";
        ...
        public static prt030L Get(string Pr_date, string Pr_no)
        {
            // 查詢資料庫資料
            ArrayList parm = new ArrayList();
            parm.Add(Pr_date.Trim());

...
namespace EVAERP.Models
{
    class prt031L
    {
        ...
        public decimal CAmt_16 { get; set; }//累計 應發薪資
        public decimal CAmt_28 { get; set; }//累計 醫療保險
        public decimal CAmt_29 { get; set; }//累計 養老保險
        public decimal CAmt_30 { get; set; }//累計 失業保險
        public decimal CAmt_31 { get; set; }//累計 住房公積金
        public decimal CTax_1 { get; set; }//累計 子女教育
        public decimal CTax_2 { get; set; }//累計 繼續教育
        public decimal CTax_3 { get; set; }//累計 大病醫療
        public decimal CTax_4 { get; set; }//累計 房貸利息
        public decimal CTax_5 { get; set; }//累計 住房租金
        public decimal CTax_6 { get; set; }//累計 贍養老人
        public decimal CFreetax { get; set; }//累計 新稅法免除費用

        public decimal CFreeamt { get; set; }//累計 3險1金

        public decimal Rate { get; set; }//稅率
        public decimal Rsub { get; set; }//稅率扣除數
        ...
        public static IEnumerable<prt031L> ToDoList(decimal? Yy, decimal? Mm, string Cdept_no, string Pr_no, decimal? Pr_sqe)
        {
            ...
            //部門
            if (!string.IsNullOrEmpty(Cdept_no.Trim()) && Cdept_no != null)
            {
                sql += " and cdept_no in " + String.Format("({0})", Cdept_no.Trim());
            }
            //工號
            if (!string.IsNullOrEmpty(Pr_no.Trim()))
            {
        ...
        public string Insert()
        {
            try
            {
                ...
                parm.Add(string.IsNullOrEmpty(System.Convert.ToString(Amt_32)) ? 0 : Amt_32);
                ...
                else
                {
                    ...
                    sql += "amt_21,amt_25,amt_26,amt_27,amt_28,amt_29,amt_30,amt_31,amt_32,";
        ...
        public static prt031L Get(decimal Yy, decimal Mm, string Pr_no, decimal Pr_sqe)
        {
            ...
            return new prt031L
            {
                ...
                Amt_32 = DeptDS.Tables[0].Rows[0].IsNull("amt_32") ? 0 : DeptDS.Tables[0].Rows[0].Field<decimal>("amt_32"),
              ...
              decimal Tot_wtime, decimal Tot_vtime1, decimal Tot_vtime2, decimal Tot_ntime, decimal Tot_atime1, decimal Tot_atime2, decimal Tot_atime)
        {
            ...
            p_prt031L.Amt_16 = p_prt031L.Amt_1 + p_prt031L.Amt_2 + p_prt031L.Amt_3 +
                 ...
                 p_prt031L.Amt_10 + p_prt031L.Amt_32 + p_prt031L.Amt_13 + p_prt031L.Amt_27 - p_prt031L.Amt_11 - p_prt031L.Amt_12 - p_prt031L.Amt_15;
            ...
            //所得稅(amt19)
            p_prt031L.Amt_19 = CalcuteTax.Get(Yy, Mm, Pr_no, p_prt031L.Amt_16, p_prt031L.Amt_28, p_prt031L.Amt_29, p_prt031L.Amt_30, p_prt031L.Amt_31).Amt_20;
        ...
        //public static prt031L PAmt19(decimal Yy, decimal Mm, string Pr_no)
        //{
        //    ArrayList parm = new ArrayList();
        //    parm.Add(Yy);
        //    parm.Add(Mm);
        //    parm.Add(Pr_no.Trim());
        //    string sql = null;
        //    sql += "select amt_19 from prt031L";
        //    sql += " where yy =?";
        //    sql += " and mm = ?";
        //    sql += " and pr_no =?";
        //    sql += " and pr_sqe =1";
        ...
        public static prt031L PAmt19(decimal Yy, decimal Mm, string Pr_no)
        {
            ...
            parm.Add(Pr_no.Trim());
            string sql = null;
            sql += "select sum(amt_19) amt_19 from prt031L";
            sql += " where yy =?";
            sql += " and mm >= 1";
            sql += " and mm < ?";
            sql += " and pr_no =?";
        ...
        //當年度累計稅率
        public static prt031L TSumGet(decimal Yy, decimal Mm, string Pr_no)
        {
            ArrayList parm = new ArrayList();
            parm.Add(Yy);
            parm.Add(Mm);

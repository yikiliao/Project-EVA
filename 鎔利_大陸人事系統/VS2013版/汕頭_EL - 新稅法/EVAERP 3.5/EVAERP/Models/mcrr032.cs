...
namespace EVAERP.Models
{
    class mcrr032
    {
        ...
        //    if (Dept == "L")
        //    {
        //        sql += "select prt030L.pr_date,prt030L.pr_cdept,prt016.pr_name,prt001.department_name_new cdept_name,prt030L.pr_no,prt016.pr_name,prt030L.pr_wtime,prt030L.pr_atime,prt030L.va_time1,prt030L.va_time2,prt030L.va_code1 from prt030L ";
        ...
        //    if (Dept == "S")
        //    {
        //        sql += "select prt030S.pr_date,prt030S.pr_cdept,prt016.pr_name,prt001.department_name_new cdept_name,prt030S.pr_no,prt016.pr_name,prt030S.pr_wtime,prt030S.pr_atime,prt030S.va_time1,prt030S.va_time2,prt030S.va_code1 from prt030S ";
        ...
        public static IEnumerable<mcrr032> ToDoList(string Dept, string Cdept, DateTime Bdate, DateTime Edate, string Prno) //L廠
        {
            ...
            parm.Add(Edate.ToString("yyyy/MM/dd"));
            sql = null;
            sql += "select prt030L.pr_date,prt030L.pr_cdept,prt016.pr_name,prt030L.pr_no,prt016.pr_name,prt030L.pr_wtime,prt030L.pr_atime,prt030L.va_time1,prt030L.va_time2,prt030L.va_code1 from prt030L ";
            sql += " LEFT OUTER JOIN prt016 on prt016.pr_no = prt030L.pr_no ";
            sql += " where 1=1";
            sql += " and prt030L.pr_dept = ?";
            sql += " and prt030L.pr_date >= ?";

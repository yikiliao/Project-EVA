...
namespace EDHR.Forms
{
    ...
    {
        int i = 0;        
        static List<umenuS> LS1 = new List<umenuS>();
        string Menu_Sel;
        ...
        {
            LS1.Clear();
            LS1 = umenuS.ToDoList(f_erp_id.Text).ToList();
            if (LS1.Count() == 0)
            {
                Config.Show("無符合資料");
                return;
        ...
        private void f_show(int idx)
        {
            ...
            else
            {
                ...
                bindingSource1.DataSource = umenuS.SelectByUser(f_erp_id.Text).ToList();
        ...
        private void user_search_from_bt_Click(object sender, EventArgs e)
        {
            ...
            if (Menu_Sel == "Add")
            {
                ...
                bindingSource1.DataSource = umenuS.SelectByUser(f_erp_id_from.Text).ToList();
                //把gridview 的ckeckbox 設成打勾
                GridView_check_f();
            }
        }

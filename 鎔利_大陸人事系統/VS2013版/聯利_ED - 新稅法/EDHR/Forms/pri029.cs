...
namespace EDHR.Forms
{
    public partial class pri029 : Form
    {
        ...
        private string f_Insert_prt021()
        {
            ...
            p_prt021.Pr_company = f_comp.Text;//公司
            p_prt021.Pr_dept = f_dept.Text;//廠部
        ...
        private void f_show(int idx)
        {
            ...
            else
            {
                ...
                f_comp.Text = LS1[idx].Pr_company;
                f_dept.Text = LS1[idx].Pr_dept;
        ...
        private void f_prno_bt_Click(object sender, EventArgs e)
        {
            ...
            pri019w fm = new pri019w(_type,DataRang);//開視窗資料
        ...
        private void f_code1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            p_prt011 = prt011.Get(f_comp.Text, f_code.Text, f_dept.Text);

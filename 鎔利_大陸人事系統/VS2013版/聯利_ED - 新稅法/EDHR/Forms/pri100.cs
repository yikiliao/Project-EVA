...
namespace EDHR.Forms
{
    ...
    {   
        ...
        private void Pay_Trn(decimal Yy, string Dept, string Sdate)
        {
            ...
            new prt035D().Delete(Yy, Dept); //考核基數
            new prt036D().Delete(Yy, Dept); //年終獎金
            new prt037D().Delete(Yy, Dept); //所得稅
            ...
            {
                prt035D a_prt035D = new prt035D();
                a_prt035D.Yy = Yy;
                a_prt035D.Dept = Dept;
                a_prt035D.Cdept = i.Pr_cdept;
                a_prt035D.Pr_no = i.Pr_no;
                a_prt035D.A_leader = 0.0000M;
                a_prt035D.B_leader = 0.0000M;
                a_prt035D.C_leader = 0.0000M;
                a_prt035D.D_leader = 0.0000M;
                a_prt035D.E_leader = 0.0000M;
                a_prt035D.Tot = 1.0000M; //先暫時設定為1
                a_prt035D.Memo = string.Empty;
                a_prt035D.Add_user = Home.Id;
                a_prt035D.Insert();

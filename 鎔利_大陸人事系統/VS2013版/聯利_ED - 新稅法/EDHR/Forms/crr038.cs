...
{
    public partial class crr038 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            count = mcrr038.ToDoList_L(Cdept, YY, MM, Type).Count();
            if (count == 0)
            {
                Config.Show("...無符合資料...");
        ...
        private void Print_cs(string Dept, string Cdept, Int16 YY, Int16 MM, string Type)
        {
            ...
            CrystalReport_crr038 rp = new CrystalReport_crr038();
            rp.SetDataSource(mcrr038.ToDoList_L(Cdept, YY, MM, Type));
            ...
            rp.SetParameterValue("ReportId", "crr038");//程式編號            

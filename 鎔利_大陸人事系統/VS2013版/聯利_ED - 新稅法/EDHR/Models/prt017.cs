...
namespace EDHR.Models
{
    class prt017
    {
        ...
        public static IEnumerable<prt017> ToDoList(string Tr_id_no, string Tr_type, string Dept)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            sql = null;
            ...
            if (!string.IsNullOrEmpty(Tr_type))
            {
        ...
        public static IEnumerable<prt017> ToDoList(string Tr_id_no,string Tr_no, string Tr_type, string DataRang)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            sql = null;
            ...
            if (!string.IsNullOrEmpty(Tr_no.Trim()))
            {
                parm.Add(Tr_no.Trim());
                sql += " and tr_no = ?";
            }

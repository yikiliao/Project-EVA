...
namespace EDHR.Models
{
    class prt030D
    {
        ...
        public static IEnumerable<prt030D> ToDoListEndDate(string Pr_dept, string Pr_date1, string Pr_date2, string Pr_no)
        {
            string sql = null;
            ArrayList parm = new ArrayList();

            sql = null;
            sql += "select * from prt030D where 1= 1 ";
        ...
        public static IEnumerable<prt030D> ToDoList(string Pr_dept, string Pr_date, string Pr_no)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
        ...
        public static IEnumerable<prt030D> ToDoList(string Pr_dept, Int32 YY, Int32 MM, string Pr_no)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Pr_dept.Trim());
        ...
        public static IEnumerable<prt030D> ToDoListGroup(string Pr_dept, string Pr_cdept, string Pr_date)
        {
            string sql = null;
            ArrayList parm = new ArrayList();

            sql = null;
            sql += "select pr_company, pr_dept,pr_cdept,pr_date,add_date,add_user,mod_date,mod_user from prt030D where 1= 1 ";
            if (!string.IsNullOrEmpty(Pr_dept.Trim()))
            {
                parm.Add(Pr_dept.Trim());
                sql += " and pr_dept= ?";
        ...
        public static IEnumerable<prt030D> ToDoListByGroup(string Pr_dept, Int32 YY, Int32 MM)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Pr_dept.Trim());
            ...
            parm.Add(MM);
            sql = null;
            sql += "select DISTINCT pr_no from prt030D where 1= 1 ";
            sql += " and pr_dept= ?";
            sql += " and year(pr_date)= ?";
            sql += " and month(pr_date)= ?";
            sql += " order by pr_no ";
        ...
        public static IEnumerable<prt030D> ToDoListByGroup(string Pr_dept, Int32 YY, Int32 MM, string Pr_no)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Pr_dept.Trim());
        ...
        public static IEnumerable<prt030D> ToDoListByGroup(string Pr_dept, Int32 YY, Int32 MM, string Pr_no, string Cdept)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Pr_dept.Trim());
        ...
        public static IEnumerable<prt030D> ToDoListByGroup2(string Pr_dept, Int32 YY, Int32 MM, string Pr_no, string Cdept)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Pr_dept.Trim());
            ...
            parm.Add(MM);
            sql = null;
            sql += "select DISTINCT prt030D.pr_no,prt016.pr_name from prt030D,prt016 where 1= 1 ";
            sql += " and prt030D.pr_dept= ?";
            sql += " and year(prt030D.pr_date)= ?";
            sql += " and month(prt030D.pr_date)= ?";
            sql += " and prt030D.pr_no = prt016.pr_no";
            if (!string.IsNullOrEmpty(Pr_no.Trim()))
            {
                parm.Add(Pr_no.Trim());
                sql += " and prt030D.pr_no= ?";
            }
            if (!string.IsNullOrEmpty(Cdept.Trim()))
            {
                parm.Add(Cdept.Trim());
                sql += " and prt030D.pr_cdept= ?";
            }
            sql += " order by prt030D.pr_no ";
        ...
        public static IEnumerable<prt030D> GroupCdept(string Pr_dept, Int32 YY, Int32 MM)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Pr_dept.Trim());
            ...
            parm.Add(MM);
            sql = null;
            sql += "select DISTINCT prt030D.pr_cdept,prt001.department_name_new from prt030D,prt001 where 1= 1 ";
            sql += " and prt030D.pr_dept= ?";
            sql += " and year(prt030D.pr_date)= ?";
            sql += " and month(prt030D.pr_date)= ?";
            sql += " and prt030D.pr_cdept = prt001.department_code";
            sql += " order by prt030D.pr_cdept";
        ...
        public string Delete(string Pr_date, string Pr_no)
        {
            try
            {
                ...
                parm.Add(Pr_no.Trim());
                string sql = null;
                sql += "delete from prt030D where pr_date=? and pr_no=?";
                if (DBConnector.executeSQL(Conn.GetStr(Login.DB), sql, parm) == 0)
                    return "刪除失敗";
            }
            catch (Exception ex)
        ...
        public string Delete(string Pr_dept, string Pr_cdept, string Pr_date)
        {
            try
            {
                ...
                parm.Add(Pr_date.Trim());
                string sql = null;
                sql += "delete from prt030D where pr_dept=? and pr_cdept=? and pr_date=?";
                if (DBConnector.executeSQL(Conn.GetStr(Login.DB), sql, parm) == 0)
                    return "刪除失敗";
            }
            catch (Exception ex)
        ...
        public string Update(string Pr_date, string Pr_no)
        {
            try
            {
                ...
                parm.Add(Pr_no.Trim());
                string sql = null;
                sql += "update prt030D set pr_wtime=?,pr_atime=?,pr_add1=?,pr_add2=?,va_time1=?,va_time2=?,";
        ...
        public static prt030D Get(string Pr_date, string Pr_no)
        {
            // 查詢資料庫資料
            ArrayList parm = new ArrayList();
            parm.Add(Pr_date.Trim());

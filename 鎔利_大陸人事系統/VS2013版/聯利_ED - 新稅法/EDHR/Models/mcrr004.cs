...
namespace EDHR.Models
{
    class mcrr004
    {
        ...
        public static IEnumerable<mcrr004> ToDoList(string Dept, string Cdept)
        {
            string sql = null;
            ...
            sql += " LEFT OUTER JOIN sst011 on sst011.company = prt016.pr_dept";
        ...
        public static IEnumerable<mcrr004> ToDoList(string Dept, string Cdept, DateTime Beg_date, DateTime End_date,string Stype)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Dept);
            ...
            if (Stype == "2")
            {
                sql += " and pr_leave_date is not null"; //離職
            }
        ...
        public static IEnumerable<mcrr004> ToDoList(string Dept, string Cdept, string Prno, string Type)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Dept);
        ...
        public static IEnumerable<mcrr004> ToDoListLeva(string Dept, string Cdept, DateTime Beg_date, DateTime End_date)
        {
            string sql = null;
            ArrayList parm = new ArrayList();
            parm.Add(Dept);

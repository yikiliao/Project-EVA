...
{
    public partial class mfr001 : Form
    {        
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var count = 0;
            count = mfplan.ToDoList(rPlant, rMfline, rMftable, rBegdate, rEnddate).Count();
        ...
        private void Print_cs(string rPlant, string rMfline, string rMftable, string rBegdate, string rEnddate)
        {
            ...
            CrystalReport_mfr001 rp = new CrystalReport_mfr001();
            rp.SetDataSource(mfplan.ToDoList(rPlant, rMfline, rMftable, rBegdate, rEnddate));
            ...
            rp.SetParameterValue("ReportId", "mfr001");//程式編號            
        ...
        private void Print_cs_2(string rPlant, string rMfline, string rMftable, string rBegdate, string rEnddate)
        {
            ...
            CrystalReport_mfr001_2 rp = new CrystalReport_mfr001_2();
            rp.SetDataSource(mfplan.ToDoList(rPlant, rMfline, rMftable, rBegdate, rEnddate));

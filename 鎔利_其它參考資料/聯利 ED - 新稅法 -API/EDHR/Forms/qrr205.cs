...
{
    public partial class qrr205 : Form
    { 
        ...
        {
            f_yy.DataSource = prt036D.ToDoList_YY().ToList();
        ...
        private void set_outtype()
        {
            ...
            data.Add(new DictionaryEntry("列印 明細表", "1"));
            data.Add(new DictionaryEntry("列印 彙總表", "2"));
            data.Add(new DictionaryEntry("列印 薪資袋", "3"));
        ...
        {   
            ...
            else
            {
                ...
                {
                    case "1":
                        Print_cs_A4(Dept, Cdept, YY, Prno);   //明細格式
                        break;
                    case "2":
                        Print_cs_XLS(Dept, Cdept, YY, Prno);  //彙總格式
                        break;
                    case "3":
                        Print_cs_LAY(Dept, Cdept, YY, Prno);  //彙總格式
                        break;
                    default:
                        break;
                }
        ...
        private void Print_cs_A4(string Dept, string Cdept, Int16 YY, string Prno)
        {
            var rpname = "年終獎金明細表";
            CrystalReport_qrr002 rp = new CrystalReport_qrr002();
            ...
            rp.SetParameterValue("ReportId", "qrr205");//程式編號
        ...
        private void Print_cs_XLS(string Dept, string Cdept, Int16 YY, string Prno)
        {
            var rpname = "年終獎金彙總表";
            CrystalReport_qrr002_1 rp = new CrystalReport_qrr002_1();
        ...
        private void Print_cs_LAY(string Dept, string Cdept, Int16 YY, string Prno)
        {
            var rpname = "年終獎金";
            CrystalReport_qrr002_2 rp = new CrystalReport_qrr002_2();

...
{
    public partial class crr033 : Form
    {   
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (mcrr033.ToDoList(Dept, Cdept,Beg_date,End_date).Count() == 0)
            {
                Config.Show("...無符合資料...");
        ...
        {            
            ...
            rp.SetDataSource(mcrr033.ToDoList(Dept, Cdept, Beg_date, End_date));
            ...
            rp.SetParameterValue("ReportId", "crr033");//程式編號            

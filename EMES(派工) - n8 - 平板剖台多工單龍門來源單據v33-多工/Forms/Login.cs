...
namespace EMES.Forms
{
    ...
    {        
        ...
        private void init_Form()
        {
            ...
            //連線資訊**********************
            MFPD = ConfigurationManager.ConnectionStrings["local"].ToString();   //來源
        ...
        {
            DEPT = Setupini.IniReadValue("LOCAL", "DEPT"); //部門
            ID = Setupini.IniReadValue("LOCAL", "ID"); //工作站
            LOG = Setupini.IniReadValue("LOCAL", "LOG"); //log
            RID = Setupini.IniReadValue("LOCAL", "RID"); //報工人員
            f_id.Text = ID;
            f_password.Text = ID;
        }

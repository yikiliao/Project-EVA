...
namespace HRMmail_Mtotal.Models
{
    class Employee
    {
        ...
        //抓輸入日期的資料
        public static IEnumerable<Employee> ToDoList(DateTime Begdate, DateTime Enddate)
        {
            string sql = null;
            ...
            sql = null;
            sql += "select Corporation.ShortName CorporationShortName,Corporation.Code CorporationCode, Employee.CnName CnName,CodeInfo.ScName Gender,Employee.Code Code,Department.Code DepartmentCode,Department.Name DepartmentName, b.CnName  DirectorName,Employee.JobDate,Job.Name JobName from Employee";
            ...
            sql += " LEFT OUTER JOIN Job on Job.JobId = Employee.JobId";
            sql += " LEFT OUTER JOIN CodeInfo ON CodeInfo.CodeInfoId = Employee.GenderId";
            sql += " where 1=1";
            sql += " and Employee.CreateDate  >= ?";
            sql += " and Employee.CreateDate  < ?";
            ...
            return from p in DeptDS.Tables[0].AsEnumerable()
                   select new Employee
                   {
                       ...
                       JobDate = p.Field<DateTime>("JobDate").ToString("yyyy/MM/dd"),

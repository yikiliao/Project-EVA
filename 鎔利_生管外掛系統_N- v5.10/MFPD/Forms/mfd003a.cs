...
{
    public partial class mfd003a : Form
    {
        DataTable dtEcm;
        ...
        public mfd003a(string rf,string Sfb01)
        {
            InitializeComponent();
        ...
        private void Ins_ProcschDay()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ProcschDay p_procschday = new ProcschDay();
                p_procschday.Ecm01 = f_sfb01.Text;
                p_procschday.Ecm03 = System.Convert.ToInt16(dataGridView1.Rows[i].Cells["ecm03"].Value.ToString());
                p_procschday.Ecm04 = dataGridView1.Rows[i].Cells["ecm04"].Value.ToString();
                p_procschday.Ecm45 = dataGridView1.Rows[i].Cells["ecm45"].Value.ToString();
                p_procschday.Ecm06 = dataGridView1.Rows[i].Cells["ecm06"].Value.ToString();
                p_procschday.Eca02 = dataGridView1.Rows[i].Cells["eca02"].Value.ToString();
                p_procschday.Begdate = dataGridView1.Rows[i].Cells["begdate"].Value.ToString();
                p_procschday.Enddate = dataGridView1.Rows[i].Cells["enddate"].Value.ToString();
                p_procschday.Rg = System.Convert.ToInt16(dataGridView1.Rows[i].Cells["rg"].Value.ToString());
                sql += ProcschDay.Set_Insert(p_procschday);
            }
            if (sql.Length > 0)
            {
                Double i = DOSQL.Excute(Login.WU, sql);

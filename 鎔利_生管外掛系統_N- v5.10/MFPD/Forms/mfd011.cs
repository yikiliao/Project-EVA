...
{
    public partial class mfd011 : Form
    {
        string rSfb01;
        string rEcm03;//製程序
        string Menu_Sel;
        ...
        private void init_GridView()
        {
            ...
            this.dataGridView4.Columns[2].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dataGridView4.Columns[1].Visible = false;//隱藏

            label24.Text = fillSpace(3);
            label24.BackColor = Color.LightBlue;
            label25.Text = "：生產中";

            label27.Text = fillSpace(3);
            label27.BackColor = Color.LightGreen;
            label26.Text = "：已包裝";

            btn_ecd01.Enabled = false;
            btn_ecd07.Enabled = false;
            btn_Del.Enabled = false;
            f_r_ecm03.ReadOnly = true;
            f_r_ecd01.ReadOnly = true;
            f_r_ecd02.ReadOnly = true;
            f_r_ecd07.ReadOnly = true;
            f_r_eca02.ReadOnly = true;
            f_r_rg.ReadOnly = true;
        }

        private string fillSpace(int a)
        {
            string str = string.Empty;
            char c = ' ';
            str = str.PadRight(a, c);
            return str;
        }
        ...
        {
            DataTable dt = ProcscmWork.SumScm(f_r_begdate.Text, f_r_ecd01.Text);

...
{
    public partial class mfr026 : Form
    {        
        ...
        private void init_Form()
        {
            ...
            f_enddate.Value = DateTime.Now.AddDays(0);//內定今天            
        }
        ...
        {
            DataTable dt = ecd_file.ToDoList();
            //加入一列空白可以選全部
            ...
            f_ecm04.ValueMember = "ecd01";
            f_ecm04.DisplayMember = "ecd02";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = WorkSchDay.ToList(rPlant, rMfWork, rBegdate, rEnddate);
        ...
        //    rp.SetParameterValue("ReportId", "mfr026");//程式編號            

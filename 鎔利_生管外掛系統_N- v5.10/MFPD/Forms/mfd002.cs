...
{
    public partial class mfd002 : Form
    {
        int i = 0;
        static List<mfplap> LS1 = new List<mfplap>();                
        ...
        {
            LS1.Clear();
            LS1 = mfplap.ToDoListGroup(rPlant, rMfline, rMftable, rBegdate, rEnddate).ToList();
        ...
        private void menu_add_Click(object sender, EventArgs e)
        {
            ...
            mfd002a fm = new mfd002a("A", rPlant, rMfdate, rMfline, 0);
        ...
        private void menu_edit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                mfd002a fm = new mfd002a("U", cPlant, cMfdate, cMfline, cSeqno); 
                if (fm.ShowDialog() == DialogResult.OK)
                {
                    //找資料 retive
                    fPlant = fm.rPlant;
        ...
        {
            var _p = mfplap.TToDoList(rPlant, rMfdate, rMfline, rMftable).ToList();
            bindingSource1.Clear();
            foreach (var i in _p.ToList())
            {
                ...
                a_mfplap.Wkno = i.Wkno;
                if (i.Wkno == "樣品")
                {
                    a_mfplap.Ta_sfb17 = 0; //原床厚度
                    a_mfplap.Occ02 = string.Empty;      //客戶名稱
                    a_mfplap.Ima02 = "MISC";      //品名
                    a_mfplap.Ima021 = string.Empty;    //規格
                    a_mfplap.Sfb08 = 0;      //生產數量
                    a_mfplap.Ta_sfb19 = 0; //預計生產桶數
                }
                else
                {
                    a_mfplap.Ta_sfb17 = p_sfb_file.Ta_sfb17; //原床厚度
                    a_mfplap.Occ02 = p_sfb_file.Occ02;      //客戶名稱
                    a_mfplap.Ima02 = p_sfb_file.Ima02;      //品名
                    a_mfplap.Ima021 = p_sfb_file.Ima021;    //規格
                    a_mfplap.Sfb08 = p_sfb_file.Sfb08;      //生產數量
                    a_mfplap.Ta_sfb19 = p_sfb_file.Ta_sfb19; //預計生產桶數
                }
                a_mfplap.Tubno = i.Tubno;
                a_mfplap.Upmode = string.Format("{0}*{1}*{2}", i.Ta_sfb04, i.Ta_sfb02, i.Ta_sfb03);
                a_mfplap.Downmode = string.Format("{0}*{1}*{2}", i.Ta_sfb08, i.Ta_sfb06, i.Ta_sfb07);
                a_mfplap.Seqno = i.Seqno;
        ...
        private void menu_del_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                mfd002a fm = new mfd002a("D", cPlant, cMfdate, cMfline, cSeqno);
                if (fm.ShowDialog() == DialogResult.OK)
                {
                    //找資料 retive
                    fPlant = fm.rPlant;
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            mfd002a fm = new mfd002a("S", cPlant, cMfdate, cMfline, cSeqno);
            if (fm.ShowDialog() == DialogResult.OK)
            {
                //找資料 retive
                rPlant = fm.rPlant;

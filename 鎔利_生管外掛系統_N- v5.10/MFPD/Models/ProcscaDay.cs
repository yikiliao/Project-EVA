...
namespace MFPD.Models
{
    class ProcscaDay
    {
        ...
        public static DataTable ToDoList(string rSel)
        {
            ...
            sql += "select * from procscaday where 1=1";
        ...
        public static DataTable ToDoList(string Dept, string begDate, string endDate)
        {
            ...
            sql += " and procscaday.sfb13 BETWEEN '" + begDate + "' and '" + endDate + "'";
            DataTable dt = DOSQL.GetDataTable(Login.WU, sql);
            return dt;
        }
        ...
        {
            string sql = string.Empty;
            sql += "insert into procscaday (sfb01,occ02,ima01,ima02,ima021,sfb06,sfb08,sfb13,sfb15) ";
        ...
        {
            string sql = "";
            sql += "delete procscaday where sfb01 ='" + sfb01 + "'";
            int a = DOSQL.Excute(cnstr, sql);
            return a;
        }
        public static int Ins_(ProcscaDay p_procscaday, string local)
        {
            string sql = "";
            sql += "insert into procscaday (sfb01,occ02,ima01,ima02,ima021,sfb06,sfb08,sfb13,sfb15,add_date,mod_date) ";
            ...
            using (SqlConnection conn = new SqlConnection(local))
            {
                ...
                comm.Parameters.AddWithValue("@sfb01", p_procscaday.Sfb01);
                comm.Parameters.AddWithValue("@occ02", p_procscaday.Occ02);
                comm.Parameters.AddWithValue("@ima01", p_procscaday.Ima01);
                comm.Parameters.AddWithValue("@ima02", p_procscaday.Ima02);
                comm.Parameters.AddWithValue("@ima021", p_procscaday.Ima021);
                comm.Parameters.AddWithValue("@sfb06", p_procscaday.Sfb06);
                comm.Parameters.AddWithValue("@sfb08", p_procscaday.Sfb08);
                comm.Parameters.AddWithValue("@sfb13", p_procscaday.Sfb13);
                comm.Parameters.AddWithValue("@sfb15", p_procscaday.Sfb15);

...
namespace MFPD.Models
{
    class ProcscmDay
    {
        ...
        public static string Set_Insert(ProcscmDay rc)
        {
            string sql = string.Empty;
            sql += "insert into procscmday (Sfb01,Ecb03,Schdate,Ecm04,Ecm45,Ecm06,Eca02,add_date,mod_date) ";
        ...
        {
            string sql = string.Empty;
            sql += "SELECT procscmday.sfb01,procscmday.ecm04,sfb_file.sfb08 from procscmday";
        ...
        {
            string sql = "";
            sql += "delete procscmday where sfb01 ='" + sfb01 + "'";

...
namespace MFPD.Models
{
    class ProcscmWork
    {
        ...
        public static string Set_Insert(ProcscmWork rc)
        {
            string sql = string.Empty;
            sql += "insert into procscmwork (Sfb01,Ecb03,Schdate,Ecm04,Ecm45,Ecm06,Eca02,add_date,mod_date) ";
        ...
        {
            string sql = string.Empty;
            sql += "SELECT procscmwork.sfb01,procscmwork.ecm04,sfb_file.sfb08 from procscmwork";
            sql += " LEFT OUTER JOIN sfb_file on sfb_file.sfb01 = procscmwork.sfb01";
            sql += " WHERE 1=1";
            sql += " and procscmwork.schdate = '" + Schdate + "'";
            sql += " and procscmwork.ecm04 = '" + Ecm04 + "'";
        ...
        {
            string sql = "";
            sql += "delete procscmwork where sfb01 ='" + sfb01 + "'";

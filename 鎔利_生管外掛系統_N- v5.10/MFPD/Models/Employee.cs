...
namespace MFPD.Models
{
    class Employee
    {
        ...
        public static DataTable ToList(string Dept, string EmpList)
        {
            string Schdate = DateTime.Now.ToString("yyyy/MM/dd");
        ...
        //    sql += " WHERE Convert(char(10),A.Date,111) BETWEEN '2021/12/01' AND '2021/12/01'";
        //    sql += " AND YEAR(LastWorkDate) = 9999";
        //    sql += " AND B1.Code IN ('EW','EO')";
